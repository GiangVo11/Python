...
# TODO: Import the numpy package
#
import numpy as np

# TODO: Import the pandas package
#
import pandas as pd


# TODO: Import plotting library
#
import matplotlib
...
# TODO: Read-in the provided csv file using the pandas read_csv function
...
# TODO: We are going to use the 'Adjusted Closing Price' for the further analysis,
#  therefore delete the other prices and the volume
#
del sp500['Open']
del sp500['High']
del sp500['Low']
...
# TODO: Read-in the provided csv file using the pandas read_csv function and set the index
#
...
# TODO: Combine both pandas data frames using the '.join' function of the data frames
...
# TODO: Sort the index values in ascending order
...
# TODO: Calculate the log returns for the two index price series
#  Hint: See the Python real-world financial data example for the calculation
#
indices['sp500_returns'] = np.log(indices['Adj Close_sp500'] / indices['Adj Close_sp500'].shift(1))*100
indices['vbtix_returns'] = np.log(indices['Adj Close_vbtix'] / indices['Adj Close_vbtix'].shift(1))*100



# TODO: Plot the return time series
#
indices[['sp500_returns','vbtix_returns']].plot(subplots=True, style='b', figsize=(15,12))

# TODO: Calculate the annualized mean and standard deviation of the return series
...
sp500_vol_ann = indices['sp500_returns'].std() * mt.sqrt(12)
...
vbtix_vol_ann = indices['vbtix_returns'].std() * mt.sqrt(12)
print(np.round(vbtix_vol_ann, 2))



# TODO: Calculate the correlation between the two return series
#  Hint: Use the '.corr()' function for data frames
#
sp500_vbtix_corr = indices[['sp500_returns', 'vbtix_returns']].corr()
...
# TODO: Define the risk-free rate
#
rf = 0.5

#
# TODO: Define the expected returns
...
#
cov_xy = sp500_vol_ann * vbtix_vol_ann * np.matrix(sp500_vbtix_corr).item((0,1))
Cov = np.matrix([[sp500_vol_ann * sp500_vol_ann, cov_xy], [cov_xy, vbtix_vol_ann * vbtix_vol_ann]])
# Cov = np.matrix([[sp500_vol_ann * sp500_vol_ann, cov_xy], [cov_xy, vbtix_vol_ann * vbtix_vol_ann]])
...
#  Hint #2: See the problem set slides or the lecture notes for the closed form solution of the weights
#
...
# matplotlib.pyplot.scatter(sigma_ef, mu_ef, s=1)
